...
export function AnimatedTestimonialsDemo() {
  const testimonials = [
    {
        quote:
          "Contributed to implementing Socket.io for real-time communication.",
        name: "Jayraj Ladkat",
    ...
    {
      quote:
        "Built the frontend landing page and admin dashboard.",
      name: "Sneha Jagtap",
    ...
    {
      quote:
        "Developed user and authentication pages and backend logic.",
      name: "Aditya Jain",
    ...
    {
      quote:
        "Defined schema structure and contributed to the frontend.",
      name: "Rahul Nair",
